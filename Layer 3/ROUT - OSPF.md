...
| 13     | Enable OSPF authentication                                                                                                                                                                                                                                                                                                                                                                                           | R(config-if)# ip ospf authentication                                                                                                                                                               |
| 14     | Setup authentication password for OSPF                                                                                                                                                                                                                                                                                                                                                                               | R(config-if)# ip ospf authentication-key [password]                                                                                                                                                |
